            ...
            else
            {
                ...
                if (_rent == null)
                {
                    if (cbCustomEndDate.Checked)
                    {
                        ...
                        _carRentalManagement.AddRental(customerName, vehicle, startDate, endDate, null, null);
                    }
                    else
                    {
                        _carRentalManagement.AddRental(customerName, vehicle, startDate, double.Parse(txtPeriod.Text), null, null);
                    }
                }
                FormSaved = true;
                Close();
